...
@section('title')
<h2 style="margin-top:2px;">新增Role</h2>
@endsection
@section('contentm')
<!--中間選單-->
        ...
        <div class="panel-heading" >
            <div class="panel panel-default" >
                ...
                <div class="panel-body" style="height:100%">
                    ...
                    <form class="form-horizontal" method="POST" onsubmit="return Confirm();" action="{{ route('role_store') }}">
                            {{ csrf_field() }}
                        <div class="form-group col-md-12 form-horizontal">
                            <label for="role_name" class="col-md-2 control-label" style="text-align:right;">RoleName:</label>
                            <div class="col-md-4">
                                <input type="text" id="role_name" name="role_name" class=" col-md-4 form-control" style="width: 100%;text-align:center" value="" placeholder="請輸入Role名稱" required autofocus>
